...
public class DateFormatter implements IDateFormatter
{
    ...
    /*
     The method was static, we don't want to test static methods, and also we have an interface.
     And we have INJECTED Date object as parameter, instead of initializing it
     In the method.
    */
