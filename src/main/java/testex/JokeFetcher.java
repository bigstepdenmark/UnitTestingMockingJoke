 ...
 */
@SuppressWarnings( "ErrorInJavadoc" )
public class JokeFetcher
{
    ...
    public JokeFetcher(IDateFormatter IDateF, IFetcherFactory factory)
    {
        this.IDateF = IDateF;
    ...
    public Jokes getJokes(String jokesToFetch, String timeZone) throws JokeException
    {
        ...
        String tzString = IDateF.getFormattedDate( timeZone, new Date() );
